...
//   }
  ...
  async takePicture(camera) {
    ...
    // console.log('imagepathg', data);
    // this.props.navigation.goBack();

    // this.props.navigation.dispatch(backAction);
    // this.props.navigation.push({ imagepath: data.uri })

    // console.log('imagepaths', data.uri)

    // CameraView.img.path = data.uri

    this.props.navigation.state.params.callbacks(data)

    this.props.navigation.goBack(null)

    // this.props.navigation.state.params.cb(data)
    
    // this.props.navigation.goBack()
    // this.props.navigation.state.params.cb(data)

    // this.props.navigation.state.params.cb.imagepath = data.uri
    // this.props.navigation.state.params.cb.setState({imagepath: data.uri})
    // this.props.navigation.state.params.cb.render()

    // this.props.navigation.state.params.imagepath = data.uri;
